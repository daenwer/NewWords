# Generated by Django 3.2.15 on 2022-09-05 23:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_create_token', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('repetition_0', models.IntegerField(default=3600, verbose_name='First repetition')),
                ('repetition_1', models.IntegerField(default=28800, verbose_name='Second repetition')),
                ('repetition_2', models.IntegerField(default=86400, verbose_name='Third repetition')),
                ('repetition_3', models.IntegerField(default=259200, verbose_name='Fourth repetition')),
                ('repetition_4', models.IntegerField(default=604800, verbose_name='Fifth repetition')),
                ('repetition_5', models.IntegerField(default=1814400, verbose_name='Sixth repetition')),
                ('repetition_6', models.IntegerField(default=7776000, verbose_name='Seventh repetition')),
                ('repetition_7', models.IntegerField(default=15552000, verbose_name='Eighth repetition')),
                ('repetition_8', models.IntegerField(default=31104000, verbose_name='Ninth repetition')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='repeat_user', to=settings.AUTH_USER_MODEL)),
                ('user_phrase', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_phrase', to='app.userphrase')),
            ],
            options={
                'verbose_name': 'User phrase',
                'verbose_name_plural': 'User phrases',
